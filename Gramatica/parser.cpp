...
{
  "$end", "error", "$undefined", "numero", "pari", "parf", "coma",
  "$accept", "S", "INICIO", "LST_COORDENADA", "COORDENADA", YY_NULLPTR
};
#endif
...
{
      10,     1,     5,     6,     7,    14,     8,    11,    12,     0,
      13
};

static const yytype_int8 yycheck[] =
{
       7,     4,     3,     0,     6,    12,     6,     3,     6,    -1,
       5
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 50 "grasintactico.y" /* yacc.c:1646  */
    {
        Nodo *tmp = new Nodo();
        tmp->etiqueta = "S";
        tmp->idNodo = CounNodo;
...
#line 1263 "parser.cpp" /* yacc.c:1646  */
  ...
  case 4:
#line 70 "grasintactico.y" /* yacc.c:1646  */
    {
                    Nodo *tmp = (yyvsp[-2].nodo);
                    tmp->addHijo((yyvsp[0].nodo));
                    (yyval.nodo) = tmp;
                }
#line 1273 "parser.cpp" /* yacc.c:1646  */
  ...
  case 5:
#line 76 "grasintactico.y" /* yacc.c:1646  */
    {
                    Nodo *tmp = new Nodo();
...
#line 1286 "parser.cpp" /* yacc.c:1646  */
  ...
  case 6:
#line 86 "grasintactico.y" /* yacc.c:1646  */
    {
                Nodo *tmp = new Nodo();
                ...
                tmp2->valor = QString::number((yyvsp[-3].num));
                tmp2->idNodo = CounNodo;
                CounNodo++;

                Nodo *tmp3 = new Nodo();
                tmp3->etiqueta = "numero";
                tmp3->valor = QString::number((yyvsp[-3].num));
...
#line 109 "grasintactico.y" /* yacc.c:1906  */
